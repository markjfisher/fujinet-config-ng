Feature: IO library test - _fn_io_create_new

  This tests Atari _fn_io_create_new

  Scenario Outline: execute _fn_io_create_new
    Given atari application test setup
      And I add common io files
      And I add common src file "io/fn_io_create_new.s"
      And I add file for compiling "features/atari/io/test-apps/test_fn_io_create_new.s"
    ...
    Then I expect to see DDEVIC equal $70
     ...
     And I expect to see DBUFLO equal lo(fn_new_disk)
     And I expect to see DBUFHI equal hi(fn_new_disk)

    # check the new disk has expected data
    When I hex dump memory between fn_new_disk and fn_new_disk+16

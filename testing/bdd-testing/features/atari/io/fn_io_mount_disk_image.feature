Feature: IO library test - _fn_io_mount_disk_image

  This tests Atari _fn_io_mount_disk_image

  Scenario: execute _fn_io_mount_disk_image
    Given atari application test setup
      And I add common io files
      And I add common src file "io/fn_io_mount_disk_image.s"
      And I add file for compiling "features/atari/io/test-apps/test_fn_io_mount_disk_image.s"

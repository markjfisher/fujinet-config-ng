Feature: IO library test - _fn_io_put_host_slots

  This tests Atari _fn_io_put_host_slots

  Scenario: execute _fn_io_put_host_slots
    Given atari simple test setup
      And I add common io files
      And I add common src file "io/fn_io_get_host_slots.s"
      And I add common src file "io/fn_io_put_host_slots.s"

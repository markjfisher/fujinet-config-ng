Feature: IO library test - _fn_io_scan_for_networks

  This tests Atari _fn_io_scan_for_networks

  Scenario Outline: execute _fn_io_scan_for_networks
    Given atari simple test setup
      And I add common io files
      And I add common src file "io/fn_io_scan_for_networks.s"
      And I add file for compiling "features/atari/io/siov-stubs/siov-dbuflo1.s"

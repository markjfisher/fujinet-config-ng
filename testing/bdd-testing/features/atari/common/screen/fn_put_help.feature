Feature: Screen Functions test - _put_help

  This tests Atari screen function _put_help to place a help string on correct line

  Scenario: Running _put_help puts help string on first line
    Given atari application test setup
      And I add atari src file "common/screen/put_msg.s"
      ...
      And I add file for compiling "features/atari/common/screen/test_put_help.s"
  ...
  # Scenario: Running _put_help puts help string on second line
  #   Given atari application test setup
  #     And I add atari src file "common/screen/put_msg.s"
  #     And I add atari src file "common/screen/put_s.s"
  #     And I add atari src file "common/screen/get_scrloc.s"

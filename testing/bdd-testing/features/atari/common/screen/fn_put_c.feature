Feature: Screen Functions test - fn_put_c
  ...
  Scenario Outline: Running fn_put_c writes internal code to given screen coordinates
    Given atari application test setup
      And I add atari src file "common/screen/fn_put_c.s"
      And I add atari src file "common/screen/fn_put_s.s"
      And I add file for compiling "features/atari/common/screen/test_fn_put_c.s"
      And I create and load application
      And I write memory at t_x with <x>
      And I write memory at t_y with <y>
      And I write memory at t_c with <char>
      And I execute the procedure at _init for no more than 45 instructions

     # Validate fn_get_scrloc was called with correct parameters

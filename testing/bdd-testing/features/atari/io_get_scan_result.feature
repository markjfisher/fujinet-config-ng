Feature: IO library test - io_get_scan_result

  This tests Atari io_get_scan_result

  ##############################################################################################################
  Scenario: execute io_get_scan_result
    Given atari simple test setup
      And I add file for compiling "../../src/atari/io_get_scan_result.s"
    ...
    Then I expect to see DDEVIC equal $70
     ...
     And I expect to see DBUFLO equal lo(io_ssidinfo)
     And I expect to see DBUFHI equal hi(io_ssidinfo)

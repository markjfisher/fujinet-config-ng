Feature: Screen Functions test - _fn_get_scrloc

  This tests Atari screen function _fn_get_scrloc to get the location of x,y coordinate within border

  Scenario Outline: Running _fn_get_scrloc sets ptr4 to x/y location
    Given atari application test setup
      ...
      And I add file for compiling "features/atari/screen/test_fn_get_scrloc.s"

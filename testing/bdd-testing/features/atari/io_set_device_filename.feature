Feature: IO library test - io_set_device_filename

  This tests Atari io_set_device_filename

  ##############################################################################################################
  Scenario Outline: execute io_set_device_filename
    Given atari simple test setup
      And I add file for compiling "../../src/atari/io_set_device_filename.s"
     ...
     When I set register A to <slot_offset>
      And I execute the procedure at io_set_device_filename for no more than 250 instructions

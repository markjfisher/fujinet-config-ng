; FONT: cushion
    ...
    .byte $00, $60, $6C, $18, $30, $6C, $0C, $00 ; %
    .byte $38, $60, $66, $3C, $66, $66, $3E, $00 ; &
    .byte $18, $18, $00, $00, $00, $00, $00, $00 ; '
    .byte $1C, $30, $60, $60, $60, $60, $30, $1C ; (
    .byte $70, $18, $0C, $0C, $0C, $0C, $18, $70 ; )
    ...
    .byte $7C, $06, $06, $3C, $60, $60, $7E, $00 ; 2
    .byte $7C, $06, $06, $1C, $06, $06, $7C, $00 ; 3
    .byte $66, $66, $66, $66, $3E, $06, $06, $00 ; 4
    .byte $7E, $60, $60, $7C, $06, $06, $7C, $00 ; 5
    .byte $3C, $60, $60, $7C, $66, $66, $3C, $00 ; 6
    .byte $7E, $06, $06, $0C, $0C, $18, $18, $00 ; 7
    .byte $3C, $66, $66, $3C, $66, $66, $3C, $00 ; 8
    .byte $3C, $66, $66, $3E, $06, $06, $3C, $00 ; 9
    .byte $00, $00, $00, $18, $00, $00, $18, $00 ; :
    .byte $00, $00, $00, $18, $00, $00, $18, $30 ; ;
    .byte $0C, $18, $30, $60, $30, $18, $0C, $00 ; <
    .byte $00, $00, $7C, $00, $7C, $00, $00, $00 ; =
    .byte $60, $30, $18, $0C, $18, $30, $60, $00 ; >
    .byte $7C, $06, $06, $0C, $18, $00, $18, $00 ; ?
    .byte $7C, $C6, $DE, $F6, $DE, $C0, $7C, $00 ; @
    .byte $3C, $66, $66, $7E, $66, $66, $66, $00 ; A
    .byte $7C, $66, $66, $7C, $66, $66, $7C, $00 ; B
    .byte $3E, $60, $60, $60, $60, $60, $3E, $00 ; C
    .byte $7C, $66, $66, $66, $66, $66, $7C, $00 ; D
    .byte $3E, $60, $60, $7C, $60, $60, $3E, $00 ; E
    .byte $3E, $60, $60, $7C, $60, $60, $60, $00 ; F
    .byte $3E, $60, $60, $66, $66, $66, $3E, $00 ; G
    .byte $66, $66, $66, $7E, $66, $66, $66, $00 ; H
    .byte $18, $18, $18, $18, $18, $18, $18, $00 ; I
    .byte $06, $06, $06, $06, $06, $06, $7C, $00 ; J
    .byte $66, $6C, $78, $70, $78, $6C, $66, $00 ; K
    .byte $60, $60, $60, $60, $60, $60, $3E, $00 ; L
    .byte $6C, $FE, $D6, $D6, $C6, $C6, $C6, $00 ; M
    .byte $3C, $66, $66, $66, $66, $66, $66, $00 ; N
    .byte $3C, $66, $66, $66, $66, $66, $3C, $00 ; O
    .byte $7C, $66, $66, $66, $7C, $60, $60, $00 ; P
    .byte $3C, $66, $66, $66, $66, $6C, $36, $00 ; Q
    .byte $7C, $66, $66, $66, $7C, $6C, $66, $00 ; R
    .byte $3C, $60, $60, $3C, $06, $06, $3C, $00 ; S
    .byte $7E, $18, $18, $18, $18, $18, $18, $00 ; T
    .byte $66, $66, $66, $66, $66, $66, $3C, $00 ; U
    .byte $66, $66, $66, $66, $66, $3C, $18, $00 ; V
    .byte $C6, $C6, $C6, $D6, $D6, $FE, $6C, $00 ; W
    ...
    .byte $1E, $30, $30, $78, $30, $30, $7E, $00 ; ball
    .byte $00, $00, $3C, $66, $66, $66, $3E, $00 ; a
    .byte $60, $60, $7C, $66, $66, $66, $3C, $00 ; b
    .byte $00, $00, $3C, $60, $60, $60, $3C, $00 ; c
    .byte $06, $06, $3E, $66, $66, $66, $3C, $00 ; d
    .byte $00, $00, $3C, $66, $7E, $60, $3E, $00 ; e
    .byte $1C, $30, $30, $78, $30, $30, $30, $00 ; f
    .byte $00, $00, $3C, $66, $66, $3E, $06, $3C ; g
    ...
    .byte $00, $00, $6C, $FE, $D6, $D6, $C6, $00 ; m
    .byte $00, $00, $3C, $66, $66, $66, $66, $00 ; n
    .byte $00, $00, $3C, $66, $66, $66, $3C, $00 ; o
    .byte $00, $00, $3C, $66, $66, $7C, $60, $60 ; p
    .byte $00, $00, $3C, $66, $66, $3E, $06, $06 ; q
    .byte $00, $00, $3C, $60, $60, $60, $60, $00 ; r
    .byte $00, $00, $3C, $60, $3C, $06, $3C, $00 ; s
    .byte $18, $18, $3C, $18, $18, $18, $18, $00 ; t
    .byte $00, $00, $66, $66, $66, $66, $3C, $00 ; u
    .byte $00, $00, $66, $66, $66, $3C, $18, $00 ; v
    .byte $00, $00, $C6, $D6, $D6, $FE, $6C, $00 ; w
